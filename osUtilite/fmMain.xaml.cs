...
namespace osUtilite
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void fmMain_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            item1.Click += MenuItemAbout_Click; mainMenu.Items.Add(item1);

            System.Windows.Controls.MenuItem item3 = new System.Windows.Controls.MenuItem();
            item3.Header = "Settings"; item3.Click += MenuItemSettings_Click; mainMenu.Items.Add(item3);
            ...
            item5.Header = "Exit"; item5.Click += MenuItemExit_Click; mainMenu.Items.Add(item5);
        ...
        private void ttTick(object sender, EventArgs e)
        {
            if (newFmTimeChecker.Visibility == Visibility.Visible)
            {
                ...
                _TimeChecker2.rwTop.Height = new GridLength(_TimeChecker2.rwTop.MaxHeight * newFmTimeChecker.slTimeChecker.Value / newFmTimeChecker.slTimeChecker.Maximum);
            }
            else

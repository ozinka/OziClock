...
namespace osUtilite
{
    class OsClock
    {
        ...
        public OsClock(string caption, string timeZone, string bkColor, int position)
        {
            ...
            newGrid.Width = 99; newGrid.Height = 60;
            newGrid.HorizontalAlignment = HorizontalAlignment.Left;
            newGrid.Margin = new Thickness(position, 0, 0, 0);

            LinearGradientBrush br = new LinearGradientBrush();
            br.StartPoint = new Point(0.5, -0.05); br.EndPoint = new Point(0.5, 1);          
            br.GradientStops.Add(new GradientStop((Color)ColorConverter.ConvertFromString("#FF383838"), 0.453));  //"#FF383838"

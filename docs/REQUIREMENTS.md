...
- **PLN-08:** Month renders a six-week calendar with daily Event and scheduled-task counts; Year renders twelve month summaries. Both support previous/current/next navigation, preserve their visible period, highlight today, and allow a Year month to open in Month view.

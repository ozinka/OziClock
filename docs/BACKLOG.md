...
| BL-054 | P1 | Candidate | Reminders | Add recurring reminder schedules | Add daily, selected-weekday weekly, monthly and yearly recurrence. Define end-of-month, leap-day, DST, missed-occurrence and edit semantics before implementation. |

...
| --- | --- | --- | --- | --- | --- |
| BL-058 | P3 | In Progress | Plan events | Add personal calendar events | EVT-01–07 establish typed validated mutations, Week rendering, selection, a shared timed/all-day editor, confirmed deletion, overlap lanes, calendar date picking and 15-minute time controls. Next add alert offsets and Does not repeat/Daily/Weekly/Monthly/Yearly recurrence. Exclude participants, invitations, shared calendars and network sync. Preserve a series model for future Custom rules and per-occurrence exceptions. |
